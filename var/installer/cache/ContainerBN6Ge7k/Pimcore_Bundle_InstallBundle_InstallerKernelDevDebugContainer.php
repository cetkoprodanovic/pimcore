...
class Pimcore_Bundle_InstallBundle_InstallerKernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CR-AuHgLSJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'installer-61b4b57459a7f1.82607637',
            ...
            'kernel.secret' => 'installer-61b4b57459a7f1.82607637',
