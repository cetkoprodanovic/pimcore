...
/**
* @method static \Pimcore\Model\DataObject\News\Listing getList()
...
* @method static \Pimcore\Model\DataObject\News\Listing|\Pimcore\Model\DataObject\News|null getByDfgdsfgsdfgsdf($value, $limit = 0, $offset = 0, $objectTypes = null)
*/
...
/**
* Get dfgdsfgsdfgsdf - dfgdsfgsdfgsdf
* @return string|null
*/
public function getDfgdsfgsdfgsdf(): ?string
{
	if ($this instanceof PreGetValueHookInterface && !\Pimcore::inAdmin()) {
		$preValue = $this->preGetValue("dfgdsfgsdfgsdf");
		if ($preValue !== null) {
			return $preValue;
		}
	}

	$data = $this->dfgdsfgsdfgsdf;
...
/**
* Set dfgdsfgsdfgsdf - dfgdsfgsdfgsdf
* @param string|null $dfgdsfgsdfgsdf
* @return \Pimcore\Model\DataObject\News
*/
public function setDfgdsfgsdfgsdf(?string $dfgdsfgsdfgsdf)
{
	$this->dfgdsfgsdfgsdf = $dfgdsfgsdfgsdf;
