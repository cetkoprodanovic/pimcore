 ...
 */
class getPricingControllerService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/bundles/EcommerceFrameworkBundle/Controller/PricingController.php';

        $container->services['Pimcore\\Bundle\\EcommerceFrameworkBundle\\Controller\\PricingController'] = $instance = new \Pimcore\Bundle\EcommerceFrameworkBundle\Controller\PricingController();

        $instance->setContainer(($container->privates['.service_locator.487RsJm'] ?? $container->load('get_ServiceLocator_487RsJmService'))->withContext('Pimcore\\Bundle\\EcommerceFrameworkBundle\\Controller\\PricingController', $container));
