 ...
 */
class getCronTriggerCommandService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setActionTriggerListener(($container->services['cmf.event_listener.action_trigger'] ?? $container->load('getCmf_EventListener_ActionTriggerService')));
