 ...
 */
class getPimcore_Datahub_Graphql_DataobjectmutationtypegeneratorDatatypeManyToManyObjectRelationService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['pimcore.datahub.graphql.dataobjectmutationtypegenerator_datatype_manyToManyObjectRelation'] = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectMutationFieldConfigGenerator\ManyToManyObjectRelation(($container->services['Pimcore\\Bundle\\DataHubBundle\\GraphQL\\Service'] ?? $container->load('getService2Service')), ($container->privates['Pimcore\\Bundle\\DataHubBundle\\GraphQL\\DataObjectType\\ElementDescriptorInputType'] ?? $container->load('getElementDescriptorInputTypeService')));
    }
}
