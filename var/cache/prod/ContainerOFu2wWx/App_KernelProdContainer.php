...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Pimcore\\Bundle\\EcommerceFrameworkBundle\\Tools\\Installer' => 'getInstaller3Service',
            'Pimcore\\Bundle\\EcommerceFrameworkBundle\\Unzer\\Installer' => 'getInstaller4Service',
            ...
            'cmf.event_listener.maintenance' => 'getCmf_EventListener_MaintenanceService',
        ...
        $this->aliases = [
            'App\\Kernel' => 'kernel',
            'CustomerManagementFrameworkBundle\\ActionTrigger\\EventHandler\\EventHandlerInterface' => 'cmf.event_listener.action_trigger',
            'CustomerManagementFrameworkBundle\\ActionTrigger\\Queue\\QueueInterface' => 'cmf.action_trigger.queue',
            ...
            'CustomerManagementFrameworkBundle\\CustomerList\\ExporterManagerInterface' => 'cmf.customer_exporter_manager',
            ...
            'CustomerManagementFrameworkBundle\\LinkGenerator\\LinkActivityDefinitionLinkGenerator' => 'cmf.link-activity-definition.linkgenerator',
    ...
    {
        $this->services['.container.private.twig'] = $instance = new \Twig\Environment(($this->privates['twig.loader.native_filesystem'] ?? $this->getTwig_Loader_NativeFilesystemService()), ['debug' => false, 'strict_variables' => false, 'autoescape' => 'name', 'cache' => ($this->targetDir.''.'/twig'), 'charset' => 'UTF-8']);
        ...
        $c = ($this->services['Symfony\\Contracts\\Translation\\TranslatorInterface'] ?? $this->getTranslatorInterfaceService());
        $d = ($this->services['pimcore.routing.router.request_context'] ?? $this->getPimcore_Routing_Router_RequestContextService());

        $e = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy(), new \Symfony\Component\Asset\Context\RequestStackContext($a, $d->getBaseUrl(), $d->isSecure())), new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0));
        $f = ($this->services['router'] ?? $this->getRouterService());
        $g = ($this->services['App\\Website\\LinkGenerator\\CategoryLinkGenerator'] ?? $this->getCategoryLinkGeneratorService());
        $h = ($this->privates['Pimcore\\Twig\\Extension\\Templating\\Navigation'] ?? $this->getNavigationService());
        $i = ($this->privates['Pimcore\\Twig\\Extension\\Templating\\Placeholder'] ?? $this->getPlaceholderService());
        $j = ($this->services['Pimcore\\Http\\Request\\Resolver\\EditmodeResolver'] ?? $this->getEditmodeResolverService());
        $k = new \Symfony\Bridge\Twig\AppVariable();
        $k->setEnvironment('prod');
        $k->setDebug(false);
        ...
        $instance->addExtension(new \App\Twig\Extension\CategoryFilterExtension($g));
        ...
        $instance->addExtension(new \App\Twig\Extension\GeneralFilterExtension($c));
        $instance->addExtension(new \App\Twig\Extension\NavigationExtension($h, $i, $g));
        ...
        $instance->addExtension(new \App\Twig\Extension\ProductPageExtension(($this->services['App\\Website\\LinkGenerator\\ProductLinkGenerator'] ?? $this->getProductLinkGeneratorService()), $c));
        ...
        $instance->addExtension(new \App\Twig\Extension\PrintCatalogExtension($c, $i));
        ...
        $instance->addExtension(new \Pimcore\Twig\Extension\CacheExtension($j));
    ...
    protected function getSegmentManagerInterfaceService()
    {
        ...
        $a = new \CustomerManagementFrameworkBundle\SegmentBuilder\StateSegmentBuilder();

        $b = ($this->services['Knp\\Component\\Pager\\PaginatorInterface'] ?? $this->getPaginatorInterfaceService());

        $a->setPaginator($b);
        $c = new \CustomerManagementFrameworkBundle\SegmentBuilder\GenderSegmentBuilder();
        $c->setPaginator($b);
        $d = new \App\CustomerManagementFramework\SegmentBuilder\ProductInterestSegmentBuilder(($this->privates['App\\Ecommerce\\IndexService\\SegmentGetter'] ?? $this->getSegmentGetterService()));
        $d->setPaginator($b);

        $instance->addSegmentBuilder($a);
        $instance->addSegmentBuilder($c);
    ...
    {
        return $this->services['cmf.activity_store'] = new \CustomerManagementFrameworkBundle\ActivityStore\MySQL(($this->services['Knp\\Component\\Pager\\PaginatorInterface'] ?? $this->getPaginatorInterfaceService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['driver' => 'pdo_mysql', 'charset' => 'UTF8MB4', 'host' => '127.0.0.1', 'port' => '3306', 'user' => 'bn_pimcore', 'password' => '22e4e16ef2ec91635d443054b3068f5814aaa461d7bd429874bde79f9d7d954a', 'dbname' => 'bitnami_pimcore', 'driverOptions' => [], 'wrapperClass' => '\\Pimcore\\Db\\Connection', 'serverVersion' => '5.5.5-10.3.32-MariaDB', 'defaultTableOptions' => ['charset' => 'UTF8MB4', 'collate' => 'utf8mb4_general_ci']], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('plugin.cmf.new-activity', [0 => function () {
            return ($this->services['cmf.event_listener.action_trigger'] ?? $this->load('getCmf_EventListener_ActionTriggerService'));
        }, 1 => 'handleEvent'], 0);
    ...
    protected function getHttpKernelService()
    {
        return $this->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel(($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), ($this->privates['controller_resolver'] ?? $this->getControllerResolverService()), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($this->privates['argument_metadata_factory'] ?? ($this->privates['argument_metadata_factory'] = new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory())), new RewindableGenerator(function () {
            ...
            yield 4 => ($this->privates['Pimcore\\Controller\\ArgumentValueResolver\\DocumentValueResolver'] ?? $this->load('getDocumentValueResolverService'));
            yield 5 => ($this->privates['Pimcore\\Controller\\ArgumentValueResolver\\EditmodeValueResolver'] ?? $this->load('getEditmodeValueResolverService'));
            yield 6 => ($this->privates['Pimcore\\Controller\\ArgumentValueResolver\\WebsiteConfigValueResolver'] ?? ($this->privates['Pimcore\\Controller\\ArgumentValueResolver\\WebsiteConfigValueResolver'] = new \Pimcore\Controller\ArgumentValueResolver\WebsiteConfigValueResolver()));
    ...
    {
        return $this->services['pimcore_ecommerce.environment'] = new \App\Ecommerce\Overrides\Environment(($this->services['session'] ?? $this->load('getSessionService')), ($this->services['Pimcore\\Localization\\LocaleServiceInterface'] ?? $this->getLocaleServiceInterfaceService()), []);
    }
    ...
    {
        $a = new \Pimcore\Bundle\EcommerceFrameworkBundle\Tracking\Tracker\Analytics\EnhancedEcommerce(new \Pimcore\Bundle\EcommerceFrameworkBundle\Tracking\TrackingItemBuilder(), ($this->services['.container.private.twig'] ?? $this->get_Container_Private_TwigService()));
        $a->setTracker(($this->privates['Pimcore\\Analytics\\Google\\Tracker'] ?? $this->getTrackerService()));

        $this->services['pimcore_ecommerce.tracking.tracking_manager'] = $instance = new \Pimcore\Bundle\EcommerceFrameworkBundle\Tracking\TrackingManager(($this->services['pimcore_ecommerce.environment'] ?? $this->getPimcoreEcommerce_EnvironmentService()), [0 => $a]);

        $instance->setSession(($this->services['session'] ?? $this->load('getSessionService')));
    ...
    /*
     * Gets the private '.service_locator.R7b9ZBB' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_R7b9ZBBService()
    {
        return $this->privates['.service_locator.R7b9ZBB'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['Pimcore\\Targeting\\Storage\\CookieStorage'] = new \Pimcore\Targeting\Storage\CookieStorage(new \Pimcore\Targeting\Storage\Cookie\JWTCookieSaveHandler('mOh6536xDgPgqzIaQ1/Hp4l5JwAkZkXPXxfC5uE9Nbw=', [], NULL, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService())), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
    }
    ...
    {
        return $this->privates['Pimcore\\Twig\\Extension\\Templating\\PimcoreUrl'] = new \App\Website\Tool\PimcoreUrl(($this->services['router'] ?? $this->getRouterService()), ($this->services['Pimcore\\Http\\RequestHelper'] ?? $this->getRequestHelperService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tnEvzLWuq4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['controller_resolver'] = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($this, ($this->services['monolog.logger.request'] ?? $this->getMonolog_Logger_RequestService()));
    }
    ...
    {
        return $this->privates['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, ($this->services['monolog.logger.php'] ?? $this->getMonolog_Logger_PhpService()), NULL, 0, false, false, NULL);
    }
    ...
    {
        return $this->privates['exception_listener'] = new \Symfony\Component\HttpKernel\EventListener\ErrorListener('error_controller', ($this->services['monolog.logger.request'] ?? $this->getMonolog_Logger_RequestService()), false, []);
    }
    ...
    {
        $this->privates['hwi_oauth.security.oauth_utils'] = $instance = new \CustomerManagementFrameworkBundle\Security\OAuth\OAuthUtils(($this->privates['security.http_utils'] ?? $this->getSecurity_HttpUtilsService()), ($this->services['.container.private.security.authorization_checker'] ?? $this->get_Container_Private_Security_AuthorizationCheckerService()), false, 'IS_AUTHENTICATED_REMEMBERED');
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/prod.log'), 400, true, NULL, false);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        return $this->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['security.access.role_hierarchy_voter'] ?? $this->load('getSecurity_Access_RoleHierarchyVoterService'));
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.R7b9ZBB'] ?? $this->get_ServiceLocator_R7b9ZBBService()), new RewindableGenerator(function () {
    ...
    protected function getTwig_Runtime_HttpkernelService()
    {
        ...
        return $this->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'inline' => '?',
        ]), $a, false), new \Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator('/_fragment', new \Symfony\Component\HttpKernel\UriSigner('mOh6536xDgPgqzIaQ1/Hp4l5JwAkZkXPXxfC5uE9Nbw='), $a));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'PimcorePaymentProviderUnzerBundle' => 'Pimcore\\Bundle\\EcommerceFrameworkBundle\\PimcorePaymentProviderUnzerBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'PimcorePaymentProviderUnzerBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/pimcore/payment-provider-unzer/src'),
                    'namespace' => 'Pimcore\\Bundle\\EcommerceFrameworkBundle',
                ],
                'HttplugBundle' => [
            ...
            'customer_management_framework.firewall_settings' => [
                ...
                'guard' => [
                    'authenticators' => [
                        0 => 'CustomerManagementFrameworkBundle\\Security\\Guard\\WebserviceAuthenticator',
                    ],
                ],
            ],
            'secret' => 'mOh6536xDgPgqzIaQ1/Hp4l5JwAkZkXPXxfC5uE9Nbw=',
            'google_client_id' => '<google_client_id>',
            'google_client_secret' => '<google_client_secret>',
            'twitter_client_id' => '<twitter_client_id>',
            'twitter_client_secret' => '<twitter_client_secret>',
            'app_encryption_secret' => 'TQwX8zIZ4/k1mbrLh14NmK5dvhnU/4EHLfZn5kMfuEo=',
            ...
            'kernel.secret' => 'mOh6536xDgPgqzIaQ1/Hp4l5JwAkZkXPXxfC5uE9Nbw=',
            ...
            'security.demo_frontend._indexed_authenticators' => [
                ...
                'security' => [
                    'encoder_factories' => [
                        ...
                        'Pimcore\\Model\\DataObject\\Customer' => [
                            'id' => 'cmf.security.user_password_encoder_factory',
                        ],
                    ],
            ...
            'pimcore_customer_management_framework.encryption.secret' => 'TQwX8zIZ4/k1mbrLh14NmK5dvhnU/4EHLfZn5kMfuEo=',
            ...
            'console.command.ids' => [
                ...
                4 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\ClassCommand',
                5 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\CustomLayoutCommand',
                6 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\FieldCollectionCommand',
                7 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Definition\\Import\\ObjectBrickCommand',
                8 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\DeleteClassificationStoreCommand',
                9 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\DeleteUnusedLocaleDataCommand',
                10 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\GeneratePagePreviews',
                11 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\MigrateElementsCommand',
                12 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\EmailLogsCleanupCommand',
                13 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\GenerateStaticPagesCommand',
                14 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalMigrationHelpersCommand',
                15 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalModelDaoMappingGeneratorCommand',
                16 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalUnicodeCldrLanguageTerritoryGeneratorCommand',
                17 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\LowQualityImagePreviewCommand',
                18 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MaintenanceModeCommand',
                19 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MigrateStorageCommand',
                20 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MysqlToolsCommand',
                21 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RequirementsCheckCommand',
                22 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ResetPasswordCommand',
                23 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RunScriptCommand',
                24 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\SearchBackendReindexCommand',
                25 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsClearCommand',
                26 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsImageCommand',
                27 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsVideoCommand',
                28 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\CleanupPendingOrdersCommand',
                29 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\IndexService\\BootstrapCommand',
                30 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\IndexService\\EsSyncCommand',
                31 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\IndexService\\ProcessPreparationQueueCommand',
                32 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\IndexService\\ProcessUpdateIndexQueueCommand',
                33 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\IndexService\\ResetQueueCommand',
                34 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\Voucher\\CleanupReservationsCommand',
                35 => 'console.command.public_alias.Pimcore\\Bundle\\EcommerceFrameworkBundle\\Command\\Voucher\\CleanupStatisticsCommand',
                36 => 'console.command.public_alias.CustomerManagementFrameworkBundle\\Command\\ActionTriggerQueueCommand',
                37 => 'console.command.public_alias.CustomerManagementFrameworkBundle\\Command\\BuildSegmentsCommand',
                38 => 'console.command.public_alias.CustomerManagementFrameworkBundle\\Command\\CronTriggerCommand',
                39 => 'console.command.public_alias.CustomerManagementFrameworkBundle\\Command\\DuplicatesIndexCommand',
                40 => 'console.command.public_alias.CustomerManagementFrameworkBundle\\Command\\MaintenanceCommand',
                41 => 'console.command.public_alias.CustomerManagementFrameworkBundle\\Command\\SegmentAssignmentIndexCommand',
                42 => 'console.command.public_alias.Pimcore\\Bundle\\DataHubBundle\\Command\\GraphQL\\RebuildDefinitionsCommand',
            ],
        ];
    }
