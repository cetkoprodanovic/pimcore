 ...
 */
class getPimcore_CustomReport_Adapter_FactoriesService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['pimcore.custom_report.adapter.factories'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'termSegmentBuilder' => ['services', 'cmf.custom_report.adapter.term_segment_builder', 'getCmf_CustomReport_Adapter_TermSegmentBuilderService', true],
        ], [
            'analytics' => '?',
            'sql' => '?',
            'termSegmentBuilder' => '?',
