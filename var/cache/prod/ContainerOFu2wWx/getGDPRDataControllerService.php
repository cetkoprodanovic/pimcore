 ...
 */
class getGDPRDataControllerService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.487RsJm'] ?? $container->load('get_ServiceLocator_487RsJmService'))->withContext('CustomerManagementFrameworkBundle\\Controller\\Admin\\GDPRDataController', $container));
