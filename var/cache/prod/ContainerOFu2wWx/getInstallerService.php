 ...
 */
class getInstallerService extends App_KernelProdContainer
{
    /*
     * Gets the public 'CustomerManagementFrameworkBundle\Installer' shared autowired service.
     *
     * @return \CustomerManagementFrameworkBundle\Installer
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/customer-management-framework-bundle/src/Installer.php';
        ...
        $container->services['CustomerManagementFrameworkBundle\\Installer'] = $instance = new \CustomerManagementFrameworkBundle\Installer(($container->services['kernel'] ?? $container->get('kernel'))->getBundle("PimcoreCustomerManagementFrameworkBundle"));
