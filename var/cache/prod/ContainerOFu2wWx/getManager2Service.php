 ...
 */
class getManager2Service extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['Pimcore\\Bundle\\AdminBundle\\GDPR\\DataProvider\\Manager'] = new \Pimcore\Bundle\AdminBundle\GDPR\DataProvider\Manager(new \Pimcore\DependencyInjection\CollectionServiceLocator(['CustomerManagementFrameworkBundle\\GDPR\\DataProvider\\Customers' => function () use ($container) {
            return ($container->privates['CustomerManagementFrameworkBundle\\GDPR\\DataProvider\\Customers'] ?? $container->load('getCustomersService'));
        }, 'Pimcore\\Bundle\\AdminBundle\\GDPR\\DataProvider\\Assets' => function () use ($container) {
