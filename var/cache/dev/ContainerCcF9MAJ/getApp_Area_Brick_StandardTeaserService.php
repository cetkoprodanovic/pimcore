 ...
 */
class getApp_Area_Brick_StandardTeaserService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.standard_teaser' shared autowired service.
     *
     * @return \App\Document\Areabrick\StandardTeaser
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/StandardTeaser.php';

        $container->privates['app.area.brick.standard_teaser'] = $instance = new \App\Document\Areabrick\StandardTeaser();
