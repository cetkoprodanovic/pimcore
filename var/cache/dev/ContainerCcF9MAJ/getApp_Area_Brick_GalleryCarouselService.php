 ...
 */
class getApp_Area_Brick_GalleryCarouselService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.gallery_carousel' shared autowired service.
     *
     * @return \App\Document\Areabrick\GalleryCarousel
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/GalleryCarousel.php';

        $container->privates['app.area.brick.gallery_carousel'] = $instance = new \App\Document\Areabrick\GalleryCarousel();
