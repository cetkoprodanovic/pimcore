 ...
 */
class getMonolog_Logger_PimcoreEcommerceSqlService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->services['monolog.logger.pimcore_ecommerce_sql'] = $instance = new \Symfony\Bridge\Monolog\Logger('pimcore_ecommerce_sql');
