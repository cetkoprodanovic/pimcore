 ...
 */
class getApp_Area_Brick_EmailWysiwygService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.email_wysiwyg' shared autowired service.
     *
     * @return \App\Document\Areabrick\EmailWysiwyg
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/EmailWysiwyg.php';

        $container->privates['app.area.brick.email_wysiwyg'] = $instance = new \App\Document\Areabrick\EmailWysiwyg();
