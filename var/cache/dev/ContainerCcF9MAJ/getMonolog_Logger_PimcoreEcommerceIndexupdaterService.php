 ...
 */
class getMonolog_Logger_PimcoreEcommerceIndexupdaterService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->services['monolog.logger.pimcore_ecommerce_indexupdater'] = $instance = new \Symfony\Bridge\Monolog\Logger('pimcore_ecommerce_indexupdater');
