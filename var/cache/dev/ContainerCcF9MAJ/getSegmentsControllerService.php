 ...
 */
class getSegmentsControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'CustomerManagementFrameworkBundle\Controller\Rest\Api\SegmentsController' shared autowired service.
     *
     * @return \CustomerManagementFrameworkBundle\Controller\Rest\Api\SegmentsController
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/customer-management-framework-bundle/src/Controller/Rest/Api/SegmentsController.php';

        $container->services['CustomerManagementFrameworkBundle\\Controller\\Rest\\Api\\SegmentsController'] = $instance = new \CustomerManagementFrameworkBundle\Controller\Rest\Api\SegmentsController();

        $instance->setContainer(($container->privates['.service_locator.487RsJm'] ?? $container->load('get_ServiceLocator_487RsJmService'))->withContext('CustomerManagementFrameworkBundle\\Controller\\Rest\\Api\\SegmentsController', $container));
