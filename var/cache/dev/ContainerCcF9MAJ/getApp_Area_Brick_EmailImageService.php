 ...
 */
class getApp_Area_Brick_EmailImageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.email_image' shared autowired service.
     *
     * @return \App\Document\Areabrick\EmailImage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/EmailImage.php';

        $container->privates['app.area.brick.email_image'] = $instance = new \App\Document\Areabrick\EmailImage();
