 ...
 */
class getApp_Area_Brick_ImageMetadataService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.image_metadata' shared autowired service.
     *
     * @return \App\Document\Areabrick\ImageMetadata
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/ImageMetadata.php';

        $container->privates['app.area.brick.image_metadata'] = $instance = new \App\Document\Areabrick\ImageMetadata();
