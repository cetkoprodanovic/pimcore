 ...
 */
class get_Messenger_HandlerDescriptor_AxmPPI9Service extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.messenger.handler_descriptor.axmPPI9'] = new \Symfony\Component\Messenger\Handler\HandlerDescriptor(new \Presta\SitemapBundle\Messenger\DumpSitemapMessageHandler(($container->services['router'] ?? $container->getRouterService()), ($container->services['presta_sitemap.dumper'] ?? $container->load('getPrestaSitemap_DumperService')), (\dirname(__DIR__, 4).'/public')), []);
    }
}
