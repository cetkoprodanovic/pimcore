...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $instance->addExtension(new \Pimcore\Twig\Extension\GlossaryExtension(new \Pimcore\Tool\Glossary\Processor(($this->services['Pimcore\\Http\\RequestHelper'] ?? $this->getRequestHelperService()), $o, ($this->services['Pimcore\\Http\\Request\\Resolver\\DocumentResolver'] ?? $this->getDocumentResolverService()))));
    ...
    protected function getPimcore_Cache_Adapter_RedisTagAware_RecorderInnerService($lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Cache\Adapter\RedisTagAwareAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('redis://localhost', ['lazy' => true]), 'bB1O0Ngu8C', 0, new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    protected function getTwig_Runtime_HttpkernelService()
    {
        ...
        return $this->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'inline' => '?',
        ]), $a, true), new \Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator('/_fragment', new \Symfony\Component\HttpKernel\UriSigner('mOh6536xDgPgqzIaQ1/Hp4l5JwAkZkXPXxfC5uE9Nbw='), $a));
    }
