 ...
 */
class getApp_Area_Brick_EmailTeaserService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.email_teaser' shared autowired service.
     *
     * @return \App\Document\Areabrick\EmailTeaser
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/EmailTeaser.php';

        $container->privates['app.area.brick.email_teaser'] = $instance = new \App\Document\Areabrick\EmailTeaser();
