 ...
 */
class getApp_Area_Brick_PrintProductRowService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.print_product_row' shared autowired service.
     *
     * @return \App\Document\Areabrick\PrintProductRow
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/PrintProductRow.php';

        $container->privates['app.area.brick.print_product_row'] = $instance = new \App\Document\Areabrick\PrintProductRow();
