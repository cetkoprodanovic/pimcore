 ...
 */
class getApp_Area_Brick_GallerySingleImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.gallery_single_images' shared autowired service.
     *
     * @return \App\Document\Areabrick\GallerySingleImages
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/GallerySingleImages.php';

        $container->privates['app.area.brick.gallery_single_images'] = $instance = new \App\Document\Areabrick\GallerySingleImages();
