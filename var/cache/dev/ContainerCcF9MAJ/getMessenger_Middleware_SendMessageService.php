...
class getMessenger_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['Pimcore\\Messenger\\SendNewsletterMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\VideoConvertMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\CleanupThumbnailsMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\SearchBackendMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\SanityCheckMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\AssetUpdateTasksMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\GenerateWeb2PrintPdfMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\VersionDeleteMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\OptimizeImageMessage' => [0 => 'pimcore_core'], 'Pimcore\\Messenger\\MaintenanceTaskMessage' => [0 => 'pimcore_maintenance']], ($container->privates['.service_locator.9phc0O8'] ?? $container->load('get_ServiceLocator_9phc0O8Service'))), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()));
