 ...
 */
class getApp_Area_Brick_TextAccordionService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.text_accordion' shared autowired service.
     *
     * @return \App\Document\Areabrick\TextAccordion
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/TextAccordion.php';

        $container->privates['app.area.brick.text_accordion'] = $instance = new \App\Document\Areabrick\TextAccordion();
