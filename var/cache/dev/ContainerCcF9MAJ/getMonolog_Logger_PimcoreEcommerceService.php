 ...
 */
class getMonolog_Logger_PimcoreEcommerceService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->services['monolog.logger.pimcore_ecommerce'] = $instance = new \Symfony\Bridge\Monolog\Logger('pimcore_ecommerce');
