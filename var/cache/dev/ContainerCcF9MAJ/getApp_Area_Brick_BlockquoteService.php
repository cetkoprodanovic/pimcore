 ...
 */
class getApp_Area_Brick_BlockquoteService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.blockquote' shared autowired service.
     *
     * @return \App\Document\Areabrick\Blockquote
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/Blockquote.php';

        $container->privates['app.area.brick.blockquote'] = $instance = new \App\Document\Areabrick\Blockquote();
