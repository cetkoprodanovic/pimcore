 ...
 */
class getSecurity_EventDispatcher_DemoFrontendService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->privates['security.event_dispatcher.demo_frontend'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () use ($container) {
            return ($container->privates['security.logout.listener.legacy_success_listener.demo_frontend'] ?? $container->load('getSecurity_Logout_Listener_LegacySuccessListener_DemoFrontendService'));
        }, 1 => 'onLogout'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () use ($container) {
            return ($container->privates['security.logout.listener.remember_me.demo_frontend'] ?? $container->load('getSecurity_Logout_Listener_RememberMe_DemoFrontendService'));
        }, 1 => 'onLogout'], 0);
