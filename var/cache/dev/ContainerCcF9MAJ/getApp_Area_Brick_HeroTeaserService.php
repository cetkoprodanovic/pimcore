 ...
 */
class getApp_Area_Brick_HeroTeaserService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.hero_teaser' shared autowired service.
     *
     * @return \App\Document\Areabrick\HeroTeaser
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/HeroTeaser.php';

        $container->privates['app.area.brick.hero_teaser'] = $instance = new \App\Document\Areabrick\HeroTeaser();
