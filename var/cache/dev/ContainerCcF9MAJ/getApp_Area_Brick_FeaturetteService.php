 ...
 */
class getApp_Area_Brick_FeaturetteService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.featurette' shared autowired service.
     *
     * @return \App\Document\Areabrick\Featurette
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/Featurette.php';

        $container->privates['app.area.brick.featurette'] = $instance = new \App\Document\Areabrick\Featurette();
