...
class getDoctrine_Migrations_DependencyFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addMigrationsDirectory('CustomerManagementFrameworkBundle\\Migrations\\PimcoreX', (\dirname(__DIR__, 4).'/vendor/pimcore/customer-management-framework-bundle/src/Migrations/PimcoreX'));
        $a->addMigrationsDirectory('Web2PrintToolsBundle\\Migrations\\PimcoreX', (\dirname(__DIR__, 4).'/vendor/pimcore/web2print-tools-bundle/src/Migrations/PimcoreX'));
