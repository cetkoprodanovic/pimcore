 ...
 */
class getMonolog_Logger_PimcoreEcommerceFindologicService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->services['monolog.logger.pimcore_ecommerce_findologic'] = $instance = new \Symfony\Bridge\Monolog\Logger('pimcore_ecommerce_findologic');
