 ...
 */
class getApp_Area_Brick_PrintWysiwygService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.print_wysiwyg' shared autowired service.
     *
     * @return \App\Document\Areabrick\PrintWysiwyg
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/PrintWysiwyg.php';

        $container->privates['app.area.brick.print_wysiwyg'] = $instance = new \App\Document\Areabrick\PrintWysiwyg();
