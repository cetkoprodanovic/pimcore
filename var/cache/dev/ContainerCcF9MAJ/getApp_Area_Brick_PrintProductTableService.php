 ...
 */
class getApp_Area_Brick_PrintProductTableService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.print_product_table' shared autowired service.
     *
     * @return \App\Document\Areabrick\PrintProductTable
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/PrintProductTable.php';

        $container->privates['app.area.brick.print_product_table'] = $instance = new \App\Document\Areabrick\PrintProductTable();
