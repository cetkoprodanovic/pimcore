 ...
 */
class getApp_Area_Brick_ImageHotspotMarkerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.image_hotspot_marker' shared autowired service.
     *
     * @return \App\Document\Areabrick\ImageHotspotMarker
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/ImageHotspotMarker.php';

        $container->privates['app.area.brick.image_hotspot_marker'] = $instance = new \App\Document\Areabrick\ImageHotspotMarker();
